	...
	return (
		<>
			<motion.div
				...
				animate={{
					backgroundColor: isOpened && resource ? 'rgba(0,0,0,0.5)' : 'rgba(0,0,0,0)',
					visibility: isOpened && resource ? 'visible' : 'hidden',
					opacity: isOpened && resource ? 1 : 0,
				}}
